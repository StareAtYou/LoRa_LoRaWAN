...
{ 	
 	...
 	RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOB, ENABLE);	 //使能PC,D,G端口时钟

	GPIO_InitStructure.GPIO_Pin =GPIO_Pin_5|GPIO_Pin_6;	 //PD5,PD6推挽输出  
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;	//复用推挽输出
	GPIO_InitStructure.GPIO_OType=GPIO_OType_OD;
	GPIO_InitStructure.GPIO_PuPd=GPIO_PuPd_UP;
 	GPIO_Init(GPIOB, &GPIO_InitStructure);	  //初始化GPIOD5,6
